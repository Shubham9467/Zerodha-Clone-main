...
1. Install dependencies for Backend, Frontend, and Dashboard.
...
2. Configure environment variables for the backend. Create `.env` in the `backend` folder with following :
   ```env
   PORT=3000
